                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <table class="tg table">
                                <thead>
                                    <tr>
                                        <th class="tg-0pky" rowspan="2">Items</th>
                                        <th class="tg-0pky" rowspan="2">Description</th>
                                        <th class="tg-0pky text-center" colspan="5">Original Contract</th>
                                    </tr>
                                    <tr>
                                        <th class="tg-0pky">Unit</th>
                                        <th class="tg-0pky">QTY</th>
                                        <th class="tg-0pky">Unit<br>Cost</th>
                                        <th class="tg-0pky">Amount</th>
                                        <th class="tg-0pky">Relative <br>Weight (%) </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td class="tg-0pky">B.9</td>
                                        <td class="tg-0pky">Mobilization/Demobilization</td>
                                        <td class="tg-0pky">Each</td>
                                        <td class="tg-0pky">1.00</td>
                                        <td class="tg-0pky">12,765.30000</td>
                                        <td class="tg-0pky">9,769</td>
